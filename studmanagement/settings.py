"""
Django settings for studmanagement project.
...
SECRET_KEY = 'django-insecure-6r^b2)5$q9r3x@k0qb&o8e-6m^6p=vd7s(n&99$v*6xl-!dn#q'
...
WSGI_APPLICATION = 'studmanagement.wsgi.application'
